...
public class Lab5b {
	...
	public static void main(String[] args) {
		...
		ObjectDetection odetect = new ObjectDetection(ls, us);
		// od.Identify();
		...
		Navigation nav = new Navigation(odo, displayDist);
		...
		/*double[][] array = { { -15.24, 76.2 }, { 15.24, 76.2 }, { 45.72, 76.2 }, { 76.2, 76.2 },
							 { 76.2, 106.68 }, { 45.72, 106.68 }, { 15.24, 106.68 }, { -15.24, 106.68 },
							 { -15.24, 137.16 }, { 15.24, 137.16 }, { 45.72, 137.16 }, { 76.2, 137.16 }, 
							 { 76.2, 167.64 }, { 45.72, 167.64 }, { 15.24, 167.64 }, { -15.24, 167.64 },
							 { -15.24, 198.12 }, { 15.24, 198.12 }, { 45.72, 198.12 }, { 76.2, 198.12 } };*/
